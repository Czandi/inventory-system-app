...
--
-- Host: 127.0.0.1
-- Czas generowania: 26 Sty 2021, 18:03
...
--
-- Struktura tabeli dla tabeli `deleted_device`
--
...
CREATE TABLE `device` (
  ...
  `id_device_set` int(11) DEFAULT NULL,
...
--
-- Struktura tabeli dla tabeli `device_set`
--
...
--
-- Zrzut danych tabeli `device_set`
--

INSERT INTO `device_set` (`id`, `name`) VALUES
(1, 'null');
...
--
-- Indeksy dla tabeli `deleted_device`
--
ALTER TABLE `deleted_device`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT dla tabeli `deleted_device`
--
ALTER TABLE `deleted_device`
...
--
-- AUTO_INCREMENT dla tabeli `device_set`
--
ALTER TABLE `device_set`
